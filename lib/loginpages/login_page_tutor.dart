...
import 'package:finalyearproject/feeds/timeline.dart';
...
import 'package:finalyearproject/profile/upload.dart';
...
//import 'package:finalyearproject/student_sign.dart';
import 'package:flutter/material.dart';
//import 'package:finalyearproject/primary_button.dart';
...
"salary":"",
 ...
 Scaffold buildAuthScreen() {
    return Scaffold(
        body: PageView(
          children: <Widget>[
                 Timeline(currentUserTutor: currentUserTutor),
       ...
       ActivityFeed(),
        ...
        bottomNavigationBar: CupertinoTabBar(
          ...
          items: [
            ...
            BottomNavigationBarItem(icon: Icon(Icons.camera_alt),title: Text('Upload'),),
...
SizedBox(width: 100,),
  ...
  textStyle: GoogleFonts.aclonica(textStyle:TextStyle(fontSize: 20, fontWeight: FontWeight.w700,color: Colors.indigo[500] ),),
