...
import 'package:finalyearproject/profile/post_screen.dart';
...
class ActivityFeedStu extends StatefulWidget {
  @override
  _ActivityFeedStuState createState() => _ActivityFeedStuState();
}

class _ActivityFeedStuState extends State<ActivityFeedStu> {
  getActivityFeed() async {
    QuerySnapshot snapshot = await activityFeedRefStu
...
class ActivityFeedItem extends StatelessWidget {
  ...
  configureMediaPreview(context) {
    ...
    if (type == 'follow') {
      activityItemText = "Accepted your request";
    }  else {
