...
import 'package:finalyearproject/feeds/feeds.dart';
...
import 'package:finalyearproject/profile/edit_profile_student.dart';
...
void editProfile() {
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => EditProfileStudent(currentUserId: currentUserId)));
  }
                        ...
                        children: <Widget>[
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              buildCountColumn("Request sent to Tutors", followingCountStu),
 //buildMore("more"),
                            ],
                          ),
                               Row(
        ...
        child: new ListView(
          children: <Widget>[
            new UserAccountsDrawerHeader(
              accountName: new Text(  "${currentUserStudent.displayName}",   style: GoogleFonts.aclonica(textStyle: TextStyle(color:Colors.white,fontWeight:FontWeight.w100),),
          ),
              accountEmail: new Text( "${currentUserStudent.email}",   style: GoogleFonts.aclonica(textStyle: TextStyle(color:Colors.white,fontWeight:FontWeight.w100),),
          ),
              decoration: BoxDecoration(
            ...
            child: Column(
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Text(
                    user.displayName,
                 style: GoogleFonts.aclonica(textStyle: TextStyle(color:Colors.black,fontSize:28,fontWeight: FontWeight.w300),
                   ), ),
                ),
