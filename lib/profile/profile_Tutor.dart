...
import 'package:finalyearproject/loginpages/login_page_tutor.dart' as tutor;
...
Container buildButtonMore({String text, Function function}) {
    return Container(
      ...
      child: Column(
        ...
        this.context,
        MaterialPageRoute(
            builder: (context) => MoreInfo(profileId: widget.profileTutorId)))
 ...
 Widget _buildPostHeading() {
    return Container(
      child: Column(
        ...
        children: <Widget>[
          Text('Posts',
             style: GoogleFonts.aclonica(textStyle: TextStyle(color:Colors.black,fontWeight:FontWeight.w100),fontSize: 30,
           ), ),],
      ),
    );
  }
...
void editProfile() {
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => EditProfile(currentUserTutorId: currentUserTutorId)));
  }
                        ...
                        children: <Widget>[
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              buildCountColumn("Request for registration", followerCount),
